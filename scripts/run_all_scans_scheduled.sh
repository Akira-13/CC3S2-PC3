#!/usr/bin/env bash
# Este script es para ser utilizado con schedule_scan.py
# Llama a los mismos scans y ejecuta security_checker_cron.py
...
python src/security_checker_scheduled.py
