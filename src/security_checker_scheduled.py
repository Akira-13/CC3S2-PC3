"""
Este script es utilizado por schedule_scan.py para comparar número de errores generados
No genera el dashboard, en comparacion a security_checker.py
"""
import json
import os
...
if __name__ == "__main__":
    ...
    generate_security_report(
        ...
        "reports/scheduled_reports/security_report_scheduled.md",
    )
